...
public class FormAcompanhante extends javax.swing.JFrame {
    FormEntrada formE;
    
    public FormAcompanhante() {
        initComponents();
       
    }

    public FormAcompanhante(JFrame form) {
       this();
       formE = (FormEntrada) form;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAcompanhante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAcompanhante().setVisible(true);
            }
        });
    }
    ...
    private void cadastrar() {
        ...
        try {
            formE.adicionarAcompanhante(acompanhante);
